...
let (__temp_no_proj : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____8705 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____8705 (FStar_List.contains s)
  
let (__temp_fast_implicits : unit -> Prims.bool) =
  fun uu____8720  -> lookup_opt "__temp_fast_implicits" as_bool 
let (admit_smt_queries : unit -> Prims.bool) =
  fun uu____8729  -> get_admit_smt_queries () 
let (admit_except : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____8738  -> get_admit_except () 
let (cache_checked_modules : unit -> Prims.bool) =
  fun uu____8745  -> get_cache_checked_modules () 
let (cache_off : unit -> Prims.bool) = fun uu____8752  -> get_cache_off () 
let (cmi : unit -> Prims.bool) = fun uu____8759  -> get_cmi () 
type codegen_t =
  | OCaml 
  | FSharp 
  | Kremlin 
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | OCaml  -> true | uu____8769 -> false
  
let (uu___is_FSharp : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | FSharp  -> true | uu____8780 -> false
  
let (uu___is_Kremlin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Kremlin  -> true | uu____8791 -> false
  
let (uu___is_Plugin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Plugin  -> true | uu____8802 -> false
  
let (codegen : unit -> codegen_t FStar_Pervasives_Native.option) =
  fun uu____8811  ->
    let uu____8812 = get_codegen ()  in
    FStar_Util.map_opt uu____8812
      (fun uu___9_8818  ->
         match uu___9_8818 with
         | "OCaml" -> OCaml
         | "FSharp" -> FSharp
         | "Kremlin" -> Kremlin
         | "Plugin" -> Plugin
...
let (codegen_libs : unit -> Prims.string Prims.list Prims.list) =
  fun uu____8837  ->
    let uu____8838 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____8838
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let (debug_any : unit -> Prims.bool) =
  fun uu____8864  -> let uu____8865 = get_debug ()  in uu____8865 <> [] 
let (debug_module : Prims.string -> Prims.bool) =
  fun modul  ->
    let uu____8882 = get_debug ()  in
...
let (debug_at_level : Prims.string -> debug_level_t -> Prims.bool) =
  fun modul  ->
    fun level  ->
      (let uu____8907 = get_debug ()  in
       FStar_All.pipe_right uu____8907
         (FStar_List.existsb (module_name_eq modul)))
        && (debug_level_geq level)
  
let (defensive : unit -> Prims.bool) =
  fun uu____8922  -> let uu____8923 = get_defensive ()  in uu____8923 <> "no" 
let (defensive_fail : unit -> Prims.bool) =
  fun uu____8933  ->
    let uu____8934 = get_defensive ()  in uu____8934 = "fail"
  
let (dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____8946  -> get_dep () 
let (detail_errors : unit -> Prims.bool) =
  fun uu____8953  -> get_detail_errors () 
let (detail_hint_replay : unit -> Prims.bool) =
  fun uu____8960  -> get_detail_hint_replay () 
let (doc : unit -> Prims.bool) = fun uu____8967  -> get_doc () 
let (dump_module : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____8977 = get_dump_module ()  in
    FStar_All.pipe_right uu____8977 (FStar_List.existsb (module_name_eq s))
  
let (eager_subtyping : unit -> Prims.bool) =
  fun uu____8992  -> get_eager_subtyping () 
let (expose_interfaces : unit -> Prims.bool) =
  fun uu____8999  -> get_expose_interfaces () 
let (fs_typ_app : Prims.string -> Prims.bool) =
  fun filename  ->
    let uu____9009 = FStar_ST.op_Bang light_off_files  in
    FStar_List.contains filename uu____9009
  
let (full_context_dependency : unit -> Prims.bool) = fun uu____9045  -> true 
let (hide_uvar_nums : unit -> Prims.bool) =
  fun uu____9053  -> get_hide_uvar_nums () 
let (hint_info : unit -> Prims.bool) =
  fun uu____9060  -> (get_hint_info ()) || (get_query_stats ()) 
let (hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9069  -> get_hint_file () 
let (ide : unit -> Prims.bool) = fun uu____9076  -> get_ide () 
let (print : unit -> Prims.bool) = fun uu____9083  -> get_print () 
let (print_in_place : unit -> Prims.bool) =
  fun uu____9090  -> get_print_in_place () 
let profile : 'a . (unit -> 'a) -> ('a -> Prims.string) -> 'a =
  fun f  ->
    fun msg  ->
      let uu____9121 = get_profile ()  in
      if uu____9121
      then
        let uu____9124 = FStar_Util.record_time f  in
        match uu____9124 with
        | (a,time) ->
            ((let uu____9135 = FStar_Util.string_of_int time  in
              let uu____9137 = msg a  in
...
let (initial_fuel : unit -> Prims.int) =
  fun uu____9148  ->
    let uu____9149 = get_initial_fuel ()  in
    let uu____9151 = get_max_fuel ()  in Prims.min uu____9149 uu____9151
  
let (initial_ifuel : unit -> Prims.int) =
  fun uu____9159  ->
    let uu____9160 = get_initial_ifuel ()  in
    let uu____9162 = get_max_ifuel ()  in Prims.min uu____9160 uu____9162
  
let (interactive : unit -> Prims.bool) =
  fun uu____9170  -> (get_in ()) || (get_ide ()) 
let (lax : unit -> Prims.bool) = fun uu____9177  -> get_lax () 
let (load : unit -> Prims.string Prims.list) = fun uu____9186  -> get_load () 
let (legacy_interactive : unit -> Prims.bool) = fun uu____9193  -> get_in () 
let (log_queries : unit -> Prims.bool) =
  fun uu____9200  -> get_log_queries () 
let (keep_query_captions : unit -> Prims.bool) =
  fun uu____9207  -> (log_queries ()) && (get_keep_query_captions ()) 
let (log_types : unit -> Prims.bool) = fun uu____9214  -> get_log_types () 
let (max_fuel : unit -> Prims.int) = fun uu____9221  -> get_max_fuel () 
let (max_ifuel : unit -> Prims.int) = fun uu____9228  -> get_max_ifuel () 
let (min_fuel : unit -> Prims.int) = fun uu____9235  -> get_min_fuel () 
let (ml_ish : unit -> Prims.bool) = fun uu____9242  -> get_MLish () 
let (set_ml_ish : unit -> unit) =
  fun uu____9248  -> set_option "MLish" (Bool true) 
let (n_cores : unit -> Prims.int) = fun uu____9257  -> get_n_cores () 
let (no_default_includes : unit -> Prims.bool) =
  fun uu____9264  -> get_no_default_includes () 
let (no_extract : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9274 = get_no_extract ()  in
    FStar_All.pipe_right uu____9274 (FStar_List.existsb (module_name_eq s))
  
let (normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____9289  -> get_normalize_pure_terms_for_extraction () 
let (no_location_info : unit -> Prims.bool) =
  fun uu____9296  -> get_no_location_info () 
let (no_plugins : unit -> Prims.bool) = fun uu____9303  -> get_no_plugins () 
let (no_smt : unit -> Prims.bool) = fun uu____9310  -> get_no_smt () 
let (output_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9319  -> get_odir () 
let (ugly : unit -> Prims.bool) = fun uu____9326  -> get_ugly () 
let (print_bound_var_types : unit -> Prims.bool) =
  fun uu____9333  -> get_print_bound_var_types () 
let (print_effect_args : unit -> Prims.bool) =
  fun uu____9340  -> get_print_effect_args () 
let (print_implicits : unit -> Prims.bool) =
  fun uu____9347  -> get_print_implicits () 
let (print_real_names : unit -> Prims.bool) =
  fun uu____9354  -> (get_prn ()) || (get_print_full_names ()) 
let (print_universes : unit -> Prims.bool) =
  fun uu____9361  -> get_print_universes () 
let (print_z3_statistics : unit -> Prims.bool) =
  fun uu____9368  -> get_print_z3_statistics () 
let (query_stats : unit -> Prims.bool) =
  fun uu____9375  -> get_query_stats () 
let (record_hints : unit -> Prims.bool) =
  fun uu____9382  -> get_record_hints () 
let (reuse_hint_for : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9391  -> get_reuse_hint_for () 
let (silent : unit -> Prims.bool) = fun uu____9398  -> get_silent () 
let (smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____9405  -> get_smtencoding_elim_box () 
let (smtencoding_nl_arith_native : unit -> Prims.bool) =
  fun uu____9412  ->
    let uu____9413 = get_smtencoding_nl_arith_repr ()  in
    uu____9413 = "native"
  
let (smtencoding_nl_arith_wrapped : unit -> Prims.bool) =
  fun uu____9423  ->
    let uu____9424 = get_smtencoding_nl_arith_repr ()  in
    uu____9424 = "wrapped"
  
let (smtencoding_nl_arith_default : unit -> Prims.bool) =
  fun uu____9434  ->
    let uu____9435 = get_smtencoding_nl_arith_repr ()  in
    uu____9435 = "boxwrap"
  
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____9445  ->
    let uu____9446 = get_smtencoding_l_arith_repr ()  in
    uu____9446 = "native"
  
let (smtencoding_l_arith_default : unit -> Prims.bool) =
  fun uu____9456  ->
    let uu____9457 = get_smtencoding_l_arith_repr ()  in
    uu____9457 = "boxwrap"
  
let (smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____9467  -> get_smtencoding_valid_intro () 
let (smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____9474  -> get_smtencoding_valid_elim () 
let (tactic_raw_binders : unit -> Prims.bool) =
  fun uu____9481  -> get_tactic_raw_binders () 
let (tactics_failhard : unit -> Prims.bool) =
  fun uu____9488  -> get_tactics_failhard () 
let (tactics_info : unit -> Prims.bool) =
  fun uu____9495  -> get_tactics_info () 
let (tactic_trace : unit -> Prims.bool) =
  fun uu____9502  -> get_tactic_trace () 
let (tactic_trace_d : unit -> Prims.int) =
  fun uu____9509  -> get_tactic_trace_d () 
let (tactics_nbe : unit -> Prims.bool) =
  fun uu____9516  -> get_tactics_nbe () 
let (tcnorm : unit -> Prims.bool) = fun uu____9523  -> get_tcnorm () 
let (timing : unit -> Prims.bool) = fun uu____9530  -> get_timing () 
let (trace_error : unit -> Prims.bool) =
  fun uu____9537  -> get_trace_error () 
let (unthrottle_inductives : unit -> Prims.bool) =
  fun uu____9544  -> get_unthrottle_inductives () 
let (unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____9551  -> get_unsafe_tactic_exec () 
let (use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____9558  -> get_use_eq_at_higher_order () 
let (use_hints : unit -> Prims.bool) = fun uu____9565  -> get_use_hints () 
let (use_hint_hashes : unit -> Prims.bool) =
  fun uu____9572  -> get_use_hint_hashes () 
let (use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9581  -> get_use_native_tactics () 
let (use_tactics : unit -> Prims.bool) =
  fun uu____9588  -> get_use_tactics () 
let (using_facts_from :
  unit -> (Prims.string Prims.list * Prims.bool) Prims.list) =
  fun uu____9604  ->
    let uu____9605 = get_using_facts_from ()  in
...
let (vcgen_optimize_bind_as_seq : unit -> Prims.bool) =
  fun uu____9659  ->
    let uu____9660 = get_vcgen_optimize_bind_as_seq ()  in
    FStar_Option.isSome uu____9660
  
let (vcgen_decorate_with_type : unit -> Prims.bool) =
  fun uu____9671  ->
    let uu____9672 = get_vcgen_optimize_bind_as_seq ()  in
    match uu____9672 with
    | FStar_Pervasives_Native.Some "with_type" -> true
    | uu____9680 -> false
  
let (warn_default_effects : unit -> Prims.bool) =
  fun uu____9691  -> get_warn_default_effects () 
let (z3_exe : unit -> Prims.string) =
  fun uu____9698  ->
    let uu____9699 = get_smt ()  in
    match uu____9699 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
  
let (z3_cliopt : unit -> Prims.string Prims.list) =
  fun uu____9717  -> get_z3cliopt () 
let (z3_refresh : unit -> Prims.bool) = fun uu____9724  -> get_z3refresh () 
let (z3_rlimit : unit -> Prims.int) = fun uu____9731  -> get_z3rlimit () 
let (z3_rlimit_factor : unit -> Prims.int) =
  fun uu____9738  -> get_z3rlimit_factor () 
let (z3_seed : unit -> Prims.int) = fun uu____9745  -> get_z3seed () 
let (use_two_phase_tc : unit -> Prims.bool) =
  fun uu____9752  ->
    (get_use_two_phase_tc ()) &&
      (let uu____9754 = lax ()  in Prims.op_Negation uu____9754)
  
let (no_positivity : unit -> Prims.bool) =
  fun uu____9762  -> get_no_positivity () 
let (ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____9769  -> get_ml_no_eta_expand_coertions () 
let (warn_error : unit -> Prims.string) =
  fun uu____9776  ->
    let uu____9777 = get_warn_error ()  in FStar_String.concat "" uu____9777
  
let (use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____9788  -> get_use_extracted_interfaces () 
let (use_nbe : unit -> Prims.bool) = fun uu____9795  -> get_use_nbe () 
let with_saved_options : 'a . (unit -> 'a) -> 'a =
  fun f  ->
    let uu____9812 =
      let uu____9814 = trace_error ()  in Prims.op_Negation uu____9814  in
    if uu____9812
    then
      (push ();
       (let r =
          try
            (fun uu___723_9829  ->
               match () with
               | () -> let uu____9834 = f ()  in FStar_Util.Inr uu____9834)
              ()
          with | uu___722_9836 -> FStar_Util.Inl uu___722_9836  in
        pop ();
        (match r with
        ...
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____10004  ->
                ...
                | (path,uu____10015) -> matches_path m_components path))
         in
      match uu____9962 with
      | FStar_Pervasives_Native.None  -> false
      | FStar_Pervasives_Native.Some (uu____10034,flag) -> flag
  
let (should_extract : Prims.string -> Prims.bool) =
  fun m  ->
    let m1 = FStar_String.lowercase m  in
    let uu____10063 = get_extract ()  in
    match uu____10063 with
    | FStar_Pervasives_Native.Some extract_setting ->
        ((let uu____10078 =
            let uu____10094 = get_no_extract ()  in
            let uu____10098 = get_extract_namespace ()  in
            let uu____10102 = get_extract_module ()  in
            (uu____10094, uu____10098, uu____10102)  in
    ...
    | FStar_Pervasives_Native.None  ->
        let should_extract_namespace m2 =
          let uu____10156 = get_extract_namespace ()  in
        ...
        let should_extract_module m2 =
          let uu____10184 = get_extract_module ()  in
          ...
          | l ->
           ...
           in
        (let uu____10206 = no_extract m1  in Prims.op_Negation uu____10206)
          &&
          (let uu____10209 =
             let uu____10220 = get_extract_namespace ()  in
             let uu____10224 = get_extract_module ()  in
             (uu____10220, uu____10224)  in
...
let (should_be_already_cached : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____10264 = get_already_cached ()  in
...
let (error_flags : unit -> error_flag Prims.list) =
  ...
  fun uu____10297  ->
    ...
    let uu____10300 = FStar_Util.smap_try_find cache we  in
