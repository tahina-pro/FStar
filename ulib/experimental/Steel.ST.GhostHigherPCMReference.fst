...
*)
module Steel.ST.GhostHigherPCMReference
open FStar.Ghost
open Steel.ST.Util
...
let ref (a:Type u#1) (p:pcm a) : Type u#0 =
    G.ref a p
...
let alloc (#o:inames)
  ...
  : STGhost (ref a pcm) o
            ...
            (ensures fun _ -> True)
  = coerce_ghost (fun _ -> G.alloc (x))

let free r = coerce_ghost (fun _ -> G.free r)
...
let write (#o:inames)
  ...
  : STGhost unit o
          ...
          (ensures fun _ -> True)
  = coerce_ghost (fun _ -> G.write r (v0) (v1))
...
let upd_gen (#o:inames)
  ...
  : STGhostT unit o
           (pts_to r x)
           (fun _ -> pts_to r y)
  = coerce_ghost (fun _ -> G.upd_gen r (x) (y) (f))
...
let share (#o:inames)
  ...
  : STGhost unit o
          ...
          (requires
                 ...
                 v == op p v0 v1)
          (ensures fun _ -> True)
  = coerce_ghost (fun _ -> G.share r (v) (v0) (v1))
...
let gather (#o:inames)
  ...
  = let _ = coerce_ghost (fun _ -> G.gather r (v0) (v1)) in
    ()
