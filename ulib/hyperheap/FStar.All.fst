...
inline let lift_exn_all (a:Type) (wp:ex_wp a)  (is_wlp:bool) (p:all_post a) (h:HyperHeap.t) = wp is_wlp (fun ra -> p ra h)
sub_effect EXN   ~> ALL = lift_exn_all

effect All (a:Type) (pre:all_pre) (post: (HyperHeap.t -> Tot (all_post a))) =
       ALL a
           (fun (is_wlp:bool) (p:all_post a) (h:HyperHeap.t) -> (is_wlp \/ pre h) /\ (forall ra h1. post h ra h1 ==> p ra h1)) (* WP  *)
effect ML (a:Type) =
