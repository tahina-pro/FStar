...
)
{
  ...
  return Crypto_AEAD_Invariant____Entry___nonce(i, e) == n;
#else
  return (Crypto_AEAD_Invariant____Entry___nonce(i, e).high == n.high && Crypto_AEAD_Invariant____Entry___nonce(i, e).low == n.low);
#endif
}
