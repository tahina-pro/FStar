...
uint8_t Crypto_Symmetric_AES_access_aux(uint8_t *sbox, uint8_t i, uint32_t ctr, uint8_t tmp)
{
  ...
  else
  {
    ...
    uint8_t _0_47 = sbox[ctr];
    uint8_t _0_48 = mask & _0_47;
    uint8_t tmp0 = tmp | _0_48;
...
void Crypto_Symmetric_AES_shiftRows(uint8_t *state)
{
  ...
  uint8_t _0_49 = state[i + (uint32_t )4];
  state[i] = _0_49;
  uint8_t _0_50 = state[i + (uint32_t )8];
  state[i + (uint32_t )4] = _0_50;
  uint8_t _0_51 = state[i + (uint32_t )12];
  state[i + (uint32_t )8] = _0_51;
  state[i + (uint32_t )12] = tmp0;
  uint32_t i0 = (uint32_t )2;
  uint8_t tmp1 = state[i0];
  uint8_t _0_52 = state[i0 + (uint32_t )8];
  state[i0] = _0_52;
  state[i0 + (uint32_t )8] = tmp1;
  uint8_t tmp2 = state[i0 + (uint32_t )4];
  uint8_t _0_53 = state[i0 + (uint32_t )12];
  state[i0 + (uint32_t )4] = _0_53;
  state[i0 + (uint32_t )12] = tmp2;
  uint32_t i1 = (uint32_t )3;
  uint8_t tmp = state[i1];
  uint8_t _0_54 = state[i1 + (uint32_t )12];
  state[i1] = _0_54;
  uint8_t _0_55 = state[i1 + (uint32_t )8];
  state[i1 + (uint32_t )12] = _0_55;
  uint8_t _0_56 = state[i1 + (uint32_t )4];
  state[i1 + (uint32_t )8] = _0_56;
...
void Crypto_Symmetric_AES_addRoundKey_(uint8_t *state, uint8_t *w, uint32_t round, uint32_t c)
{
  ...
  uint8_t _0_58 = target[(uint32_t )0];
  uint8_t _0_57 = subkey[(uint32_t )0];
  uint8_t _0_59 = _0_58 ^ _0_57;
  target[(uint32_t )0] = _0_59;
  uint8_t _0_61 = target[(uint32_t )1];
  uint8_t _0_60 = subkey[(uint32_t )1];
  uint8_t _0_62 = _0_61 ^ _0_60;
  target[(uint32_t )1] = _0_62;
  uint8_t _0_64 = target[(uint32_t )2];
  uint8_t _0_63 = subkey[(uint32_t )2];
  uint8_t _0_65 = _0_64 ^ _0_63;
  target[(uint32_t )2] = _0_65;
  uint8_t _0_67 = target[(uint32_t )3];
  uint8_t _0_66 = subkey[(uint32_t )3];
  uint8_t _0_68 = _0_67 ^ _0_66;
  target[(uint32_t )3] = _0_68;
}
...
{
  uint8_t _0_69 = word[(uint32_t )0];
  uint8_t _0_70 = Crypto_Symmetric_AES_access(sbox, _0_69);
  word[(uint32_t )0] = _0_70;
  uint8_t _0_71 = word[(uint32_t )1];
  uint8_t _0_72 = Crypto_Symmetric_AES_access(sbox, _0_71);
  word[(uint32_t )1] = _0_72;
  uint8_t _0_73 = word[(uint32_t )2];
  uint8_t _0_74 = Crypto_Symmetric_AES_access(sbox, _0_73);
  word[(uint32_t )2] = _0_74;
  uint8_t _0_75 = word[(uint32_t )3];
  uint8_t _0_76 = Crypto_Symmetric_AES_access(sbox, _0_75);
  word[(uint32_t )3] = _0_76;
}
...
void Crypto_Symmetric_AES_invShiftRows(uint8_t *state)
{
  ...
  uint8_t tmp0 = state[i];
  uint8_t _0_77 = state[i + (uint32_t )4];
  state[i] = _0_77;
  uint8_t _0_78 = state[i + (uint32_t )8];
  state[i + (uint32_t )4] = _0_78;
  uint8_t _0_79 = state[i + (uint32_t )12];
  state[i + (uint32_t )8] = _0_79;
  state[i + (uint32_t )12] = tmp0;
  uint32_t i0 = (uint32_t )2;
  uint8_t tmp1 = state[i0];
  uint8_t _0_80 = state[i0 + (uint32_t )8];
  state[i0] = _0_80;
  state[i0 + (uint32_t )8] = tmp1;
  uint8_t tmp2 = state[i0 + (uint32_t )4];
  uint8_t _0_81 = state[i0 + (uint32_t )12];
  state[i0 + (uint32_t )4] = _0_81;
  state[i0 + (uint32_t )12] = tmp2;
  uint32_t i1 = (uint32_t )1;
  uint8_t tmp = state[i1];
  uint8_t _0_82 = state[i1 + (uint32_t )12];
  state[i1] = _0_82;
  uint8_t _0_83 = state[i1 + (uint32_t )8];
  state[i1 + (uint32_t )12] = _0_83;
  uint8_t _0_84 = state[i1 + (uint32_t )4];
  state[i1 + (uint32_t )8] = _0_84;
  state[i1 + (uint32_t )4] = tmp;
}
