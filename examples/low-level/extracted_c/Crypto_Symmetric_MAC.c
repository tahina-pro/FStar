...
uint64_t *Crypto_Symmetric_MAC____B_POLY1305____0(Crypto_Symmetric_MAC__buffer projectee)
{
  ...
  {
    uint64_t *_0 = projectee.u.case_B_POLY1305.x00;
    return _0;
  }
  else
  {
...
uint8_t *Crypto_Symmetric_MAC____B_GHASH____0(Crypto_Symmetric_MAC__buffer projectee)
{
  ...
  {
    uint8_t *_0 = projectee.u.case_B_GHASH.x10;
    return _0;
  }
  else
  {
...
)
{
  ...
  {
    uint64_t *b0 = b.u.case_B_POLY1305.x00;
  ...
  {
    uint8_t *b0 = b.u.case_B_GHASH.x10;
...
)
{
  ...
  {
    uint64_t *a = scrut.snd.u.case_B_POLY1305.x00;
    uint64_t *r = scrut.fst.u.case_B_POLY1305.x00;
    uint64_t e[5] = { 0 };
  ...
  {
    uint8_t *a = scrut.snd.u.case_B_GHASH.x10;
    uint8_t *r = scrut.fst.u.case_B_GHASH.x10;
