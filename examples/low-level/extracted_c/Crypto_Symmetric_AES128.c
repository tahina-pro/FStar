...
uint8_t Crypto_Symmetric_AES128_access_aux(uint8_t *sbox, uint8_t i, uint32_t ctr, uint8_t tmp)
{
  ...
  else
  {
    ...
    uint8_t _0_85 = sbox[ctr];
    uint8_t _0_86 = mask & _0_85;
    uint8_t tmp0 = tmp | _0_86;
...
void Crypto_Symmetric_AES128_shiftRows(uint8_t *state)
{
  ...
  uint8_t _0_87 = state[i + (uint32_t )4];
  state[i] = _0_87;
  uint8_t _0_88 = state[i + (uint32_t )8];
  state[i + (uint32_t )4] = _0_88;
  uint8_t _0_89 = state[i + (uint32_t )12];
  state[i + (uint32_t )8] = _0_89;
  state[i + (uint32_t )12] = tmp0;
  uint32_t i0 = (uint32_t )2;
  uint8_t tmp1 = state[i0];
  uint8_t _0_90 = state[i0 + (uint32_t )8];
  state[i0] = _0_90;
  state[i0 + (uint32_t )8] = tmp1;
  uint8_t tmp2 = state[i0 + (uint32_t )4];
  uint8_t _0_91 = state[i0 + (uint32_t )12];
  state[i0 + (uint32_t )4] = _0_91;
  state[i0 + (uint32_t )12] = tmp2;
  uint32_t i1 = (uint32_t )3;
  uint8_t tmp = state[i1];
  uint8_t _0_92 = state[i1 + (uint32_t )12];
  state[i1] = _0_92;
  uint8_t _0_93 = state[i1 + (uint32_t )8];
  state[i1 + (uint32_t )12] = _0_93;
  uint8_t _0_94 = state[i1 + (uint32_t )4];
  state[i1 + (uint32_t )8] = _0_94;
...
Crypto_Symmetric_AES128_addRoundKey_(uint8_t *state, uint8_t *w, uint32_t round, uint32_t c)
{
  ...
  uint8_t _0_96 = target[(uint32_t )0];
  uint8_t _0_95 = subkey[(uint32_t )0];
  uint8_t _0_97 = _0_96 ^ _0_95;
  target[(uint32_t )0] = _0_97;
  uint8_t _0_99 = target[(uint32_t )1];
  uint8_t _0_98 = subkey[(uint32_t )1];
  uint8_t _0_100 = _0_99 ^ _0_98;
  target[(uint32_t )1] = _0_100;
  uint8_t _0_102 = target[(uint32_t )2];
  uint8_t _0_101 = subkey[(uint32_t )2];
  uint8_t _0_103 = _0_102 ^ _0_101;
  target[(uint32_t )2] = _0_103;
  uint8_t _0_105 = target[(uint32_t )3];
  uint8_t _0_104 = subkey[(uint32_t )3];
  uint8_t _0_106 = _0_105 ^ _0_104;
  target[(uint32_t )3] = _0_106;
}
...
{
  uint8_t state[16];
  memset(state, 0, Crypto_Symmetric_AES128_blocklen * sizeof state[0]);
  memcpy(state, input, Crypto_Symmetric_AES128_blocklen * sizeof input[0]);
  Crypto_Symmetric_AES128_addRoundKey(state, w, (uint32_t )0);
  Crypto_Symmetric_AES128_cipher_loop(state, w, sbox, (uint32_t )1);
  Crypto_Symmetric_AES128_subBytes_sbox(state, sbox);
  Crypto_Symmetric_AES128_shiftRows(state);
  Crypto_Symmetric_AES128_addRoundKey(state, w, (uint32_t )10);
  memcpy(out, state, Crypto_Symmetric_AES128_blocklen * sizeof state[0]);
}
...
{
  uint8_t _0_107 = word[(uint32_t )0];
  uint8_t _0_108 = Crypto_Symmetric_AES128_access(sbox, _0_107);
  word[(uint32_t )0] = _0_108;
  uint8_t _0_109 = word[(uint32_t )1];
  uint8_t _0_110 = Crypto_Symmetric_AES128_access(sbox, _0_109);
  word[(uint32_t )1] = _0_110;
  uint8_t _0_111 = word[(uint32_t )2];
  uint8_t _0_112 = Crypto_Symmetric_AES128_access(sbox, _0_111);
  word[(uint32_t )2] = _0_112;
  uint8_t _0_113 = word[(uint32_t )3];
  uint8_t _0_114 = Crypto_Symmetric_AES128_access(sbox, _0_113);
  word[(uint32_t )3] = _0_114;
}
...
{
  uint8_t temp[4] = { 0 };
  memcpy(w, key, Crypto_Symmetric_AES128_keylen * sizeof key[0]);
  Crypto_Symmetric_AES128_keyExpansion_aux(w, temp, sbox, (uint32_t )4);
}
...
void Crypto_Symmetric_AES128_invShiftRows(uint8_t *state)
{
  ...
  uint8_t tmp0 = state[i];
  uint8_t _0_115 = state[i + (uint32_t )4];
  state[i] = _0_115;
  uint8_t _0_116 = state[i + (uint32_t )8];
  state[i + (uint32_t )4] = _0_116;
  uint8_t _0_117 = state[i + (uint32_t )12];
  state[i + (uint32_t )8] = _0_117;
  state[i + (uint32_t )12] = tmp0;
  uint32_t i0 = (uint32_t )2;
  uint8_t tmp1 = state[i0];
  uint8_t _0_118 = state[i0 + (uint32_t )8];
  state[i0] = _0_118;
  state[i0 + (uint32_t )8] = tmp1;
  uint8_t tmp2 = state[i0 + (uint32_t )4];
  uint8_t _0_119 = state[i0 + (uint32_t )12];
  state[i0 + (uint32_t )4] = _0_119;
  state[i0 + (uint32_t )12] = tmp2;
  uint32_t i1 = (uint32_t )1;
  uint8_t tmp = state[i1];
  uint8_t _0_120 = state[i1 + (uint32_t )12];
  state[i1] = _0_120;
  uint8_t _0_121 = state[i1 + (uint32_t )8];
  state[i1 + (uint32_t )12] = _0_121;
  uint8_t _0_122 = state[i1 + (uint32_t )4];
  state[i1 + (uint32_t )8] = _0_122;
  state[i1 + (uint32_t )4] = tmp;
}
...
Crypto_Symmetric_AES128_inv_cipher(uint8_t *out, uint8_t *input, uint8_t *w, uint8_t *sbox)
{
  ...
  memcpy(state, input, Crypto_Symmetric_AES128_blocklen * sizeof input[0]);
  Crypto_Symmetric_AES128_addRoundKey(state, w, (uint32_t )10);
  Crypto_Symmetric_AES128_inv_cipher_loop(state, w, sbox, (uint32_t )9);
  Crypto_Symmetric_AES128_invShiftRows(state);
  Crypto_Symmetric_AES128_invSubBytes_sbox(state, sbox);
  Crypto_Symmetric_AES128_addRoundKey(state, w, (uint32_t )0);
  memcpy(out, state, Crypto_Symmetric_AES128_blocklen * sizeof state[0]);
