...
open FStar.Heap
inline let as_requires (#a:Type) (wp:st_wp_h heap a)  = wp false (fun x h -> True)
inline let as_ensures  (#a:Type) (wp:st_wp_h heap a) (h0:heap) (x:a) (h1:heap) = ~ (wp true (fun y h1' -> y<>x \/ h1<>h1') h0)
